...
*/
  ...
  async function main() {
	...
	`<td class='col_channel'><span class='wideonly'>${type}</span><span class='thinonly'>${type2}</span></td>` +
        ...
        `<td class='col_delete'><a href='timers.html' onclick='if(confirm("Confirm delete timer: ${t.disp_title}")) delete_timer(this,"${t.uuid}",${running})'><img src='images/delete.png' title='Delete Timer'></a></td>`;
      row.innerHTML = s;
    }
  }
